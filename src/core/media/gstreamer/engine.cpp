...
struct gstreamer::Engine::Private
{
    ...
    void on_buffering_changed(uint16_t value)
    {
        on_buffering(value);
    }
    ...
    core::Signal<uint16_t> on_buffering;
};
...
const core::Signal<uint16_t>& gstreamer::Engine::on_buffering_changed_signal() const
{
